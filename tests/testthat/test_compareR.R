test_that("compareR function tests", {
  ...
  expect_equal(output1$acc$sens.p.value, 0.001374276, tolerance = 1e-06)
  expect_equal(output1$acc$sens.p.adj, 0.002748552, tolerance = 1e-06)
  ...
  expect_equal(output1$acc$sens.p.value, 0, tolerance = 1e-06)
  expect_equal(output1$acc$sens.p.adj, 0, tolerance = 1e-06)
  expect_equal(output1$acc$spec.test.stat, 8.1, tolerance = 1e-06)
  expect_equal(output1$acc$spec.p.value, 0, tolerance = 1e-06)
  expect_equal(output1$acc$spec.p.adj, 0, tolerance = 1e-06)
